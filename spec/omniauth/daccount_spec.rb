...
RSpec.describe Omniauth::Daccount do
  ...
  let(:enterprise_token_url)     { 'https://conf.uw.docomo.ne.jp/token/o/oauth2/auth' }
  let(:enterprise) do
  ...
  context 'client options' do
    ...
    it 'should have correct token url' do
      expect(subject.options.client_options.token_url).to eq('https://conf.uw.docomo.ne.jp/token/o/oauth2/auth')
    end
